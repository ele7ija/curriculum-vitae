...
\heading{Skills}
\begin{compactitem}
	\item \textit{Web} - Backend-oriented, SQL, Apache HTTPD, Tomcat but also HTML, CSS, JS
	\item \textit{Software Development tools and practices} - Modeling (PowerDesigner), {\tt git}, JUnit, eclipse, virtualizations
	...
	\item \textit{Other} - \LaTeX, PyZMQ, Jupyter Notebook
	\item \textit{Interests} - various: RL and its applications, backend web programming, distributed apps (using PyZMQ)
