...
\textcolor{white}{
	...
	% Tagline 
	{\Large Graduate Software Engineer} \\[0.25em] 
	% Contact data
...
\timelinetable{
	2022 -- present & \educationentry{Master's: High Performance Computing}
	{Faculty of Technical Sciences}
	{University of Novi Sad, Serbia}
	{\newline Topics: distributed systems, cloud computing, parallel computer architectures}
}

\timelinetable{
	2017 -- 2021 & \educationentry{Bachelor's: Software Engineering and IT (GPA: 9.83/10)}
	{Faculty of Technical Sciences}
	{University of Novi Sad, Serbia}
...
\timelinetable{
	Dec '21 -- present & \educationentry{Member of Technical Staff 2}{Nutanix}{Belgrade, Serbia}{\newline
	Team: AHV management (VM Scheduler).

	Broad topics: distributed systems, task idempotency, pessimistic and
	optimistic distributed locking, concurrency.
	}

\\

	Oct '20 -- Mar '21 \\ (\small \textit{6 months}) &	\educationentry{Intern}{SAP}{Walldorf, Germany}{\newline
% Member of \textit{TI \& HA - Data Management and Platform}. 
Team: vSystem (multi-tenant cluster for running apps in Cloud).

% My role was \textbf{improving the caching architecture
%for user authorization throughout the cloud system}.
 \textbf{Overhauled the caching architecture for user authorization, 
 leading to a reduced duration of PR validations by 30\% and better overall cluster performance}.
...
2021 & \projectentry{\small \begin{tabular}{@{}l c c c c c c c c c c}\textit{Research} & \textendash & Go & \textendash & Concurrency & \textendash & Image processing & \textendash & Pipelines \end{tabular}}{Go Pipelines (Bachelor Thesis)}{\small \href{https://github.com/ele7ija/go-pipelines}{\tt github.com/ele7ija/go-pipelines}}
{Optimized an \textbf{image processing server} by utilizing the \textit{Pipeline} pattern and \textit{bounded concurrency} in Go. 
Compared different types of processing, visualized and analyzed the results.
\textit{Open-sourced} the library for pipeline processing.
...
%2021 & \projectentry{\small \begin{tabular}{@{}l c c c c c c c c c c}\textit{Uni team project} & \textendash & Fullstack & \textendash & Spring Boot & \textendash & x.509 Certs & \textendash & Keycloak & \textendash & Docker \end{tabular}}{Hospital Security System}{\small \href{https://github.com/djuricmilan/BSEP_T13}{\tt github.com/djuricmilan/BSEP\_T13}}
...
% ARCHIVE
% 2021 & \projectentry{\begin{tabular}{@{}l c c c c c c c c c c}\textit{Uni team project} & \textendash & Fullstack & \textendash & Document-based  & \textendash & XML & \textendash & RDF & \textendash & Docker \end{tabular}}{Document-based Information System}{\href{https://github.com/ele7ija/xml-web-services}{\tt github.com/ele7ija/xml-web-services}}
% {An extensive Information System that manages all sorts of documents in the process of requesting the information of public importance. Strong use of XML and RDF stores.}
...
\vspace{1em}
My current focus is on \textbf{Distributed systems} and my language of choice is \textbf{Go}. 
I've also done numeruous Full-Stack projects mostly in Uni and had one solo commercial project.  

\vspace{1em}
If I'm not working on a PR, I'm either swimming, hiking, cycling, playing snooker/pool or hanging out.
